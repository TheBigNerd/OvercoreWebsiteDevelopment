...
import { DeleteCPUItem } from "./cpuAction";

export default async function CPUTable() {
    const component = await prisma.cPU.findMany({ select : { id: true, title: true, imagePath: true, priceInPence: true}});
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem asChild>
                                        <Link href={`/admin/customcomponents/cpu/${component.id}/edit`}>Edit</Link>
                                    </DropdownMenuItem>
                                <DeleteCPUItem id={component.id} disabled={false} />
                                </DropdownMenuContent>
                            </DropdownMenu>
                        </TableCell>
                    </TableRow>
