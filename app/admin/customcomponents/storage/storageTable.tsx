...
import { DeleteStorageItem } from "./storageAction";

export default async function StorageTable() {
    const component = await prisma.storage.findMany({ select : { id: true, title: true, imagePath: true, priceInPence: true}});
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem asChild>
                                        <Link href={`/admin/customcomponents/storage/${component.id}/edit`}>Edit</Link>
                                    </DropdownMenuItem>
                                <DeleteStorageItem id={component.id} disabled={false} />
                                </DropdownMenuContent>
                            </DropdownMenu>
                        </TableCell>
                    </TableRow>
