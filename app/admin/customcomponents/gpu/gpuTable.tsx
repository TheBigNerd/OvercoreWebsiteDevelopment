...
import { DeleteGPUItem } from "./gpuAction";

export default async function GPUTable() {
    const component = await prisma.gpu.findMany({ select : { id: true, title: true, imagePath: true, priceInPence: true}});
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem asChild>
                                        <Link href={`/admin/customcomponents/gpu/${component.id}/edit`}>Edit</Link>
                                    </DropdownMenuItem>
                                <DeleteGPUItem id={component.id} disabled={false} />
                                </DropdownMenuContent>
                            </DropdownMenu>
                        </TableCell>
                    </TableRow>
