...
import { DeletePSUItem } from "./psuAction";

export default async function psuTable() {
    const component = await prisma.pSU.findMany({ select : { id: true, title: true, imagePath: true, priceInPence: true}});
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem asChild>
                                        <Link href={`/admin/customcomponents/psu/${component.id}/edit`}>Edit</Link>
                                    </DropdownMenuItem>
                                <DeletePSUItem id={component.id} disabled={false} />
                                </DropdownMenuContent>
                            </DropdownMenu>
                        </TableCell>
                    </TableRow>
