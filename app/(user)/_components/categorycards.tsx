...
const CategoryCard: React.FC<CategoryCardProps> = ({ src, alt, text, link, isHovered, isDimmed, onMouseEnter, onMouseLeave }) => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-0 w-full bg-black bg-opacity-50 text-white text-center py-2 px-4 text-lg md:text-xl lg:text-2xl font-mono sm:bottom-[] sm:w-[75%] sm:left-0 sm:py-7 sm:px-10">
