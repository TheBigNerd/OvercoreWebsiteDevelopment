...
export default async function CarouselLook({ product } : { product: Product }) {
	return (
		<div className="carousel-item bg-gray-300 rounded-3xl px-8 py-4">
			<Image src={product.imagePath} alt="Product Image" width={300} height={300} className="rounded-lg aspect-square object-contain"/>
